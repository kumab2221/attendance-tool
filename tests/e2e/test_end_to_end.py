...
class TestE2EIntegration:
    ...
    def test_performance_regression(self, temp_workspace, large_dataset):
        ...
        if large_dataset is None:
            ...
            data_manager.generate_large_dataset(large_dataset, num_employees=10, num_days=3)  # テスト用に小さめに調整
        
        coordinator = E2EWorkflowCoordinator()
        output_dir = temp_workspace / "output"
        
        result = coordinator.measure_performance(
            large_dataset, output_dir, "2024-01"
        )
