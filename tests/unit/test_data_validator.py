...
class TestDataValidatorCustomRules:
    ...
    def test_add_custom_rule(self):
        ...
        custom_rule = ValidationRule(
            name="department_check", validator=custom_department_rule, priority=1
        )
    ...
    def test_custom_rule_execution(self):
        ...
        custom_rule = ValidationRule(
            name="overtime_check", validator=overtime_limit_rule, priority=1
        )
...
class TestValidationReport:
    ...
    def test_validation_report_creation(self):
        ...
        errors = [
            ValidationError(
                row_number=1, field="employee_id", message="社員IDが空です", value=""
            )
        ]
        warnings = [
            ValidationWarning(
    ...
    def test_get_error_summary(self):
        ...
        errors = [
            ValidationError(
                row_number=1, field="employee_id", message="社員IDエラー", value=""
            ),
            ValidationError(
                row_number=2, field="employee_id", message="社員IDエラー", value=""
            ),
            ValidationError(
                row_number=3, field="work_date", message="日付エラー", value="invalid"
            ),
            ValidationError(
                row_number=4, field="start_time", message="時刻エラー", value="25:00"
            ),
        ]
