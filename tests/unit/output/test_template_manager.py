...
class TestTemplateManager:
    ...
    def test_generate_templated_excel_report(self, template_manager, temp_output_dir, sample_employee_data, sample_department_data):
    ...
    def test_generate_templated_csv_report(self, template_manager, temp_output_dir, sample_employee_data, sample_department_data):
    ...
    def test_generate_report_with_comparison(self, template_manager, temp_output_dir, sample_employee_data, sample_department_data):
        """比較機能付きレポート生成テスト"""
        result = template_manager.generate_templated_report(
            employee_summaries=sample_employee_data,
            department_summaries=sample_department_data,
    ...
    def test_generate_multi_month_report(self, template_manager, temp_output_dir, sample_employee_data, sample_department_data):
        """複数月統合レポート生成テスト"""
    ...
    def test_unsupported_output_format(self, template_manager, temp_output_dir, sample_employee_data, sample_department_data):
        """サポートされていない出力形式テスト"""
    ...
    def test_nonexistent_template(self, template_manager, temp_output_dir, sample_employee_data, sample_department_data):
        """存在しないテンプレート使用テスト"""
    ...
    def test_comparison_data_generation(self, template_manager, sample_employee_data, sample_department_data):
        """比較データ生成テスト"""
