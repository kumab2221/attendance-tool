...
class TestCliIntegration:
    ...
    def test_cli_process_basic(self, runner, input_csv_file, output_directory):
        ...
        result = runner.invoke(
            main, ["process", "--input", input_csv_file, "--output", output_directory]
        )
    ...
    def test_cli_process_with_date_range(
        self, runner, input_csv_file, output_directory
    ):
...
class TestFileOperations:
    ...
    def test_empty_input_file(self, runner):
        ...
        try:
            with tempfile.TemporaryDirectory() as temp_dir:
                result = runner.invoke(
                    main, ["process", "--input", empty_file, "--output", temp_dir]
                )
    ...
    def test_invalid_csv_format(self, runner, invalid_csv_data):
        ...
        try:
            with tempfile.TemporaryDirectory() as temp_dir:
                result = runner.invoke(
                    main, ["process", "--input", invalid_file, "--output", temp_dir]
                )
...
class TestErrorScenarios:
        ...
        try:
            ...
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                try:
                    result = runner.invoke(
                        main,
                        ["process", "--input", input_file, "--output", readonly_dir],
                    )
    ...
    def test_disk_space_simulation(self, runner):
        ...
        try:
            with tempfile.TemporaryDirectory() as temp_dir:
                result = runner.invoke(
                    main, ["process", "--input", input_file, "--output", temp_dir]
                )
