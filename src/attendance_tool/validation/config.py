...
class ValidationConfig:
    ...
    def _get_default_config(self) -> Dict[str, Any]:
        ...
        return {
            "validation": {
                ...
                "employee_name": {"required": True, "max_length": 50, "min_length": 1},
            },
            "date_validation": {"work_date": {"past_years": 5, "future_days": 0}},
            "time_validation": {
                "work_hours": {
    ...
    def get_quality_thresholds(self) -> Dict[str, float]:
        ...
        return quality_config.get(
            "quality_thresholds",
            {"excellent": 0.95, "good": 0.85, "acceptable": 0.70, "poor": 0.50},
        )
    ...
    def validate_config(self) -> List[str]:
        ...
        if max_hours > 48:
            errors.append(
                "最大勤務時間が48時間を超えています（労働基準法違反の可能性）"
            )
