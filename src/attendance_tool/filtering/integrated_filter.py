...
class IntegratedDateFilter:
    ...
    def load_and_filter(self, 
        ...
        if self.validator:
            ...
            if hasattr(validation_report, 'has_errors') and validation_report.has_errors:
...
class ValidatedDateFilter(DateFilter):
    ...
    def filter_with_pre_validation(self, 
        ...
        if hasattr(validation_report, 'has_critical_errors') and validation_report.has_critical_errors:
